(function (global, factory) {
  ...
  var Graphics$1 = function Graphics(root, _ref) {
    ...
    invariant(!geometry || geometry instanceof pixi_js.Graphics, "Graphics geometry needs to be a `PIXI.Graphics`");
    var g = geometry ? new pixi_js.Graphics(geometry.geometry) : new pixi_js.Graphics();
  ...
  var Sprite$1 = function Sprite(root, props) {
    var sprite = new pixi_js.Sprite(getTextureFromProps('Sprite', root, props));
