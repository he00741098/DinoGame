...
var Graphics$1 = function Graphics(root, _ref) {
  ...
  invariant(!geometry || geometry instanceof pixi_jsLegacy.Graphics, "Graphics geometry needs to be a `PIXI.Graphics`");
  var g = geometry ? new pixi_jsLegacy.Graphics(geometry.geometry) : new pixi_jsLegacy.Graphics();
...
var Sprite$1 = function Sprite(root, props) {
  var sprite = new pixi_jsLegacy.Sprite(getTextureFromProps('Sprite', root, props));
